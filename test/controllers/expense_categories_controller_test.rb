...
class ExpenseCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expense_category" do
    assert_difference("ExpenseCategory.count") do
      post expense_categories_url, params: { expense_category: { amount: @expense_category.amount, category_id: @expense_category.category_id, expense_id: @expense_category.expense_id } }
    end
  ...
  test "should update expense_category" do
    patch expense_category_url(@expense_category), params: { expense_category: { amount: @expense_category.amount, category_id: @expense_category.category_id, expense_id: @expense_category.expense_id } }
